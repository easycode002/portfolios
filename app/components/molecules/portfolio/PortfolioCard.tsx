  ...
  return (
    <Card className="overflow-hidden group">
      <CardContent className="p-0 relative">
        ...
        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-2xl object-cover transition-transform group-hover:scale-100">
          <a
            href={project.link}
      ...
      <CardFooter className="flex flex-col items-start gap-1 pt-2">
        <h3 className="font-ubunturegular">{project.title}</h3>
